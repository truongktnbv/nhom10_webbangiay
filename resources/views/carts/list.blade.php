...
@section('content')
    ...
    <div class="container">
    <div class="row">
        <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50" style="left: 350px; bottom:160px">
        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                <form action="/vnpay" method="POST">
                    @csrf
        <button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" type="submit"name="redirect" >Thanh toán online</button>
